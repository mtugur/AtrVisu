...
| Inspector semantics | PASS | Machine/non-floor Civil retain base-relative wording. Floor Area uses Top Elevation above Level and read-only Top Surface World Elevation. |
