...
| Complete local gate | PASS | Audit low 0 vulnerabilities; `npm ls --all` exit 0; token governance 268 files; interaction governance and policy tests pass; build pass; 161 unit files / 1352 tests; 100 Chromium tests; diff check at delivery. |
