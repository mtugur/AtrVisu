# PF-2B Native Asset Import Gate
...
| Persistent locator / ephemeral URL | modelStorage resolver and idempotent revocation tests |
| No partial import | Binary quota and metadata-failure compensation tests |
