...
- Source governance rejects direct `lucide-react` imports outside the registry and standalone pseudo-glyph controls in migrated surfaces.
- Component tests protect the shared action primitive, Primary Dock labels/counts, Group actions, Viewpoint actions and Library behavior.
...
- Evidence artifact: `pf3a-global-iconography-density` with ten named runtime captures.
