...
| Modal layer | Project, library, taxonomy, collision, simulation, benchmark, and layout tools |
...
- Design-token governance: passed for 221 maintained files.
- Build: passed; known bundle-size warning only.
- Unit: 130 files / 1156 tests passed.
- Chromium: 59/59 tests passed, including the real ATARA slice.
