...
export const RUNTIME_FEATURE_COMMAND_IDS = {
  ...
  commercialOutputs: "project.commercialOutputs",
  exportBomExcel: "commercial.exportBomExcel",
  ...
  addLevel: "level.add",
  renameLevel: "level.rename",
  setLevelDatum: "level.setDatum",
  deleteLevel: "level.delete",
  setActiveLevel: "level.setActive",
