...
Click a machine in the library to add a meter-scale placeholder box to the grid. Each added machine gets a visible label above it. Select an object in the 3D scene to highlight it, drag it on the floor plane, and edit its Plan X, Plan Y, or rotation angle in the properties panel.
